...
.word fcn_4_main # ClassDecl at 1.7  
CLASS_END_Main: # ClassDecl at 1.7	 
...
CLASS_END_Object: # ClassDecl at 0.0	
 .data # Program at 1.1		
  .byte 72 # StringLiteral at 3.16		 
  .byte 101 # StringLiteral at 3.16			
  .byte 108 # StringLiteral at 3.16	 	
  .byte 108 # StringLiteral at 3.16 
  .byte 111 # StringLiteral at 3.16		 
  .byte 46 # StringLiteral at 3.16 		
  .byte 10 # StringLiteral at 3.16	 	
  .byte 0 # StringLiteral at 3.16	
  .word CLASS_String # StringLiteral at 3.16 		
  .word 3 # StringLiteral at 3.16 	 
  .word -7 # StringLiteral at 3.16  
strLit_0: # StringLiteral at 3.16	
.text # Program at 1.1 
...
lw $t0,16($t0) # Call at 0.0	
jalr $t0 # Call at 0.0		 
# exit program # Program at 1.1  	
li $v0, 10 # Program at 1.1	 	
syscall # Program at 1.1 		
.globl fcn_4_main # MethodDeclVoid at 2.15 	 
fcn_4_main: # MethodDeclVoid at 2.15		
subu $sp, $sp, 8 # MethodDeclVoid at 2.15		 
sw $ra, 4($sp) # MethodDeclVoid at 2.15	
sw $s2, ($sp) # MethodDeclVoid at 2.15		
lw $s2, 8($sp) # MethodDeclVoid at 2.15 		
subu $sp, $sp, 4 # This at 3.7	
sw $s2, ($sp) # This at 3.7  	
subu $sp, $sp, 4 # StringLiteral at 3.16	
la $t0, strLit_0 # StringLiteral at 3.16		
sw $t0, ($sp) # StringLiteral at 3.16  
lw $t0,4($sp) # Call at 3.7	 
beq $t0, $zero, nullPtrException # Call at 3.7	
lw $t0, -12($t0) # Call at 3.7			
lw $t0,24($t0) # Call at 3.7	 
jalr $t0 # Call at 3.7 		
lw $ra, 4($sp) # MethodDeclVoid at 2.15	 
lw $s2, 0($sp) # MethodDeclVoid at 2.15 	 
addu $sp, $sp,12 # MethodDeclVoid at 2.15 	 
jr $ra # MethodDeclVoid at 2.15	
###############################################################
