...
.word fcn_30_main # ClassDecl at 3.7   
.word fcn_63_diffSquares # ClassDecl at 3.7  
CLASS_END_Main: # ClassDecl at 3.7			
...
strLit_15: # StringLiteral at 8.15 
  .byte 10 # StringLiteral at 10.15	  
  .byte 0 # StringLiteral at 10.15   
  .byte 0 # StringLiteral at 10.15	 
  .byte 0 # StringLiteral at 10.15   
  .word CLASS_String # StringLiteral at 10.15	
  .word 2 # StringLiteral at 10.15 		
  .word -1 # StringLiteral at 10.15	  
strLit_27: # StringLiteral at 10.15 	
.text # Program at 3.1 	
...
.globl fcn_30_main # MethodDeclVoid at 5.17 
fcn_30_main: # MethodDeclVoid at 5.17 		
subu $sp, $sp, 8 # MethodDeclVoid at 5.17 	
sw $ra, 4($sp) # MethodDeclVoid at 5.17  	
sw $s2, ($sp) # MethodDeclVoid at 5.17	 	
lw $s2, 8($sp) # MethodDeclVoid at 5.17			
lw $t0, 0($s2) # IdentifierExp at 6.2 		
subu $sp, $sp, 4 # IdentifierExp at 6.2   
sw $t0, ($sp) # IdentifierExp at 6.2		 
lw $t0, ($sp) # Assign at 6.6   
addu $sp, $sp, 4 # Assign at 6.6	  
lw $t0, 0($s2) # IdentifierExp at 7.2	 
subu $sp, $sp, 4 # IdentifierExp at 7.2   
sw $t0, ($sp) # IdentifierExp at 7.2	 	
subu $sp, $sp, 4 # This at 7.15 		
sw $s2, ($sp) # This at 7.15 		
subu $sp, $sp, 8 # IntegerLiteral at 7.27 		
sw $s5, 4($sp) # IntegerLiteral at 7.27  	
li $t0, 5 # IntegerLiteral at 7.27		
sw $t0, ($sp) # IntegerLiteral at 7.27			
subu $sp, $sp, 8 # IntegerLiteral at 7.30 	
sw $s5, 4($sp) # IntegerLiteral at 7.30 
li $t0, 12 # IntegerLiteral at 7.30  
sw $t0, ($sp) # IntegerLiteral at 7.30   
subu $sp, $sp, 4 # False at 7.34  
sw $zero,($sp) # False at 7.34 	
lw $t0,20($sp) # Call at 7.15 	 
beq $t0, $zero, nullPtrException # Call at 7.15   
lw $t0, -12($t0) # Call at 7.15			
lw $t0, 16($t0) # Call at 7.15	  
jalr $t0 # Call at 7.15 		
lw $t0,8($sp) # Call at 7.6  	
beq $t0, $zero, nullPtrException # Call at 7.6 
lw $t0, -12($t0) # Call at 7.6	 	
lw $t0, 32($t0) # Call at 7.6			
jalr $t0 # Call at 7.6   
lw $t0, 0($s2) # IdentifierExp at 8.2 	
subu $sp, $sp, 4 # IdentifierExp at 8.2	 
sw $t0, ($sp) # IdentifierExp at 8.2	
subu $sp, $sp, 4 # StringLiteral at 8.15   
la $t0, strLit_15 # StringLiteral at 8.15 	
sw $t0, ($sp) # StringLiteral at 8.15	  
lw $t0,4($sp) # Call at 8.6 	 
beq $t0, $zero, nullPtrException # Call at 8.6			
lw $t0, -12($t0) # Call at 8.6	 
lw $t0, 24($t0) # Call at 8.6 	
jalr $t0 # Call at 8.6	  
lw $t0, 0($s2) # IdentifierExp at 9.2	 	
subu $sp, $sp, 4 # IdentifierExp at 9.2   
sw $t0, ($sp) # IdentifierExp at 9.2	 	
subu $sp, $sp, 4 # This at 9.15	 
sw $s2, ($sp) # This at 9.15	 	
subu $sp, $sp, 8 # IntegerLiteral at 9.27		 
sw $s5, 4($sp) # IntegerLiteral at 9.27  	
li $t0, 8 # IntegerLiteral at 9.27		 
sw $t0, ($sp) # IntegerLiteral at 9.27  
subu $sp, $sp, 8 # IntegerLiteral at 9.30			
sw $s5, 4($sp) # IntegerLiteral at 9.30  	
li $t0, 3 # IntegerLiteral at 9.30 
sw $t0, ($sp) # IntegerLiteral at 9.30  	
subu $sp, $sp, 4 # True at 9.33		 
li $t0, 1 # True at 9.33 
sw $t0, ($sp) # True at 9.33  
lw $t0,20($sp) # Call at 9.15	 
beq $t0, $zero, nullPtrException # Call at 9.15  	
lw $t0, -12($t0) # Call at 9.15 	 
lw $t0, 16($t0) # Call at 9.15	
jalr $t0 # Call at 9.15 		
lw $t0,8($sp) # Call at 9.6	  
beq $t0, $zero, nullPtrException # Call at 9.6 		
lw $t0, -12($t0) # Call at 9.6 	
lw $t0, 32($t0) # Call at 9.6	  
jalr $t0 # Call at 9.6		 
lw $t0, 0($s2) # IdentifierExp at 10.2		 
subu $sp, $sp, 4 # IdentifierExp at 10.2	
sw $t0, ($sp) # IdentifierExp at 10.2	
subu $sp, $sp, 4 # StringLiteral at 10.15	 
la $t0, strLit_27 # StringLiteral at 10.15		
sw $t0, ($sp) # StringLiteral at 10.15			
lw $t0,4($sp) # Call at 10.6 	 
beq $t0, $zero, nullPtrException # Call at 10.6 		
lw $t0, -12($t0) # Call at 10.6   
lw $t0, 24($t0) # Call at 10.6   
jalr $t0 # Call at 10.6			
lw $ra, 4($sp) # MethodDeclVoid at 5.17	 
lw $s2, 0($sp) # MethodDeclVoid at 5.17  
addu $sp, $sp,12 # MethodDeclVoid at 5.17 		
jr $ra # MethodDeclVoid at 5.17   
.globl fcn_63_diffSquares # MethodDeclNonVoid at 12.16		 
fcn_63_diffSquares: # MethodDeclNonVoid at 12.16	 	
subu $sp, $sp, 8 # MethodDeclNonVoid at 12.16		 
sw $ra, 4($sp) # MethodDeclNonVoid at 12.16  	
sw $s2, ($sp) # MethodDeclNonVoid at 12.16		 
lw $s2, 28 ($sp) # MethodDeclNonVoid at 12.16	 
lw $t0, 20($sp) # IdentifierExp at 13.17  	
subu $sp, $sp, 8 # IdentifierExp at 13.17   
sw $s5, 4($sp) # IdentifierExp at 13.17		
sw $t0, ($sp) # IdentifierExp at 13.17			
lw $t0, 28($sp) # IdentifierExp at 13.19	  
subu $sp, $sp, 8 # IdentifierExp at 13.19	 	
sw $s5, 4($sp) # IdentifierExp at 13.19		 
sw $t0, ($sp) # IdentifierExp at 13.19	  
lw $t0, 28($sp) # IdentifierExp at 14.17	
subu $sp, $sp, 8 # IdentifierExp at 14.17			
sw $s5, 4($sp) # IdentifierExp at 14.17			
sw $t0, ($sp) # IdentifierExp at 14.17 		
lw $t0, 36($sp) # IdentifierExp at 14.19 
subu $sp, $sp, 8 # IdentifierExp at 14.19 	
sw $s5, 4($sp) # IdentifierExp at 14.19 	 
sw $t0, ($sp) # IdentifierExp at 14.19  
lw $t0, 16($sp) # IdentifierExp at 15.15	 	
subu $sp, $sp, 8 # IdentifierExp at 15.15			
sw $s5, 4($sp) # IdentifierExp at 15.15	
sw $t0, ($sp) # IdentifierExp at 15.15 
lw $t0, 8($sp) # IdentifierExp at 15.24			
subu $sp, $sp, 8 # IdentifierExp at 15.24		
sw $s5, 4($sp) # IdentifierExp at 15.24 		
sw $t0, ($sp) # IdentifierExp at 15.24		
lw $t0, ($sp) # Minus at 15.23		
lw $t1, 8($sp) # Minus at 15.23	  
subu $t0, $t1, $t0 # Minus at 15.23 		
addu $sp, $sp, 8 # Minus at 15.23 
sw $t0, ($sp) # Minus at 15.23	  
lw $t0, 48($sp) # IdentifierExp at 16.6  
subu $sp, $sp, 4 # IdentifierExp at 16.6 
sw $t0, ($sp) # IdentifierExp at 16.6 		
lw $t0, ($sp) # If at 16.2 	
addu $sp, $sp, 4 # If at 16.2		 
beq $t0, $zero, if_else_61 # If at 16.2	
lw $t0, 0($sp) # IdentifierExp at 17.6 	
subu $sp, $sp, 8 # IdentifierExp at 17.6  	
sw $s5, 4($sp) # IdentifierExp at 17.6 	 
sw $t0, ($sp) # IdentifierExp at 17.6  	
lw $t0, ($sp) # Assign at 17.13	
addu $sp, $sp, 8 # Assign at 17.13 	 
j if_done_61 # If at 16.2 	
if_else_61: # If at 16.2  	
if_done_61: # If at 16.2	 	
lw $t0, 0($sp) # IdentifierExp at 19.9	 
subu $sp, $sp, 8 # IdentifierExp at 19.9  	
sw $s5, 4($sp) # IdentifierExp at 19.9	 
sw $t0, ($sp) # IdentifierExp at 19.9			
lw $ra, 28($sp) # MethodDeclNonVoid at 12.16	 
lw $s2, 24($sp) # MethodDeclNonVoid at 12.16	 
lw $t0, ($sp) # MethodDeclNonVoid at 12.16	 
sw $t0, 28($sp) # MethodDeclNonVoid at 12.16	  
sw $s5, 32($sp) # MethodDeclNonVoid at 12.16		
addu $sp, $sp,52 # MethodDeclNonVoid at 12.16 
jr $ra # MethodDeclNonVoid at 12.16 	
###############################################################
